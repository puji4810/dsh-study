...
export const TYPERT = {
  ...
  model: {
    "services": [
      {
        "description": "StudyOS tools, workspace-scoped Vault resolution, and dashboard Remote API.",
        "summary": "StudyOS tools, workspace-scoped Vault resolution, and dashboard Remote API.",
        "tags": [],
        "jsDoc": "/** StudyOS tools, workspace-scoped Vault resolution, and dashboard Remote API. */",
        "key": "studyos",
        "exportName": "StudyOSService",
        "members": [
          {
            "kind": "method",
            "name": "overview",
            "signature": "@Remote('overview') overview(agent: Agent): StudyDashboardOverview",
            "summary": "Read the StudyOS dashboard for the calling Session's workspace Vault.",
          ...
          },
          {
            "kind": "method",
            "name": "selectProject",
            "signature": "@Remote('selectProject') selectProject(agent: Agent, projectId: string): StudyDashboardOverview",
            "summary": "Select a project in the calling Session's workspace Vault.",
        ...
        "types": [
          ...
          {
            "name": "StudyDashboardOverview",
            "declaration": "export interface StudyDashboardOverview {\n    vaultPath: string;\n    activeProjectId?: string;\n    projects: StudyDashboardProject[];\n    dueReviewCount: number;\n    dueReviews: StudyDashboardReview[];\n}"
          },
          {
            "name": "StudyDashboardProject",
            "declaration": "export interface StudyDashboardProject {\n    projectId: string;\n    title: string;\n    domain: string;\n    phase: string;\n    deadline?: string;\n    scheduleCount: number;\n    attemptCount: number;\n}"
          },
          {
            "name": "StudyDashboardReview",
            "declaration": "export interface StudyDashboardReview {\n    path: string;\n    title: string;\n    reviewLevel: number;\n    reviewCount: number;\n    nextReviewAt?: string;\n    concepts: string[];\n}"
          },
          {
